  ...
  return (
    <div className='h-[160px] w-full mt-8'>
      ...
      <div className='h-full lg:h-[100px] w-full lg:w-[40%] flex flex-col lg:flex-row justify-between items-start lg:items-center'>
        <div className='w-[100px] lg:w-[100px] h-[40px] rounded-lg p-2 flex gap-2 items-center border border-solid border-black hover:border-blue-500 cursor-pointer' onClick={() => {
