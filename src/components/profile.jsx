...
const Profile = () => {
  return (
    <motion.div
      className="relative h-[40px] w-[40px] flex justify-center items-center lg:h-[200px] lg:w-[200px] border border-solid border-white lg:rounded-full overflow-hidden"
      style={{
        textShadow:
