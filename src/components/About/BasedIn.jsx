...
const BasedIn = () => {
    return (
        <div className='h-[300px] lg:h-[100px] w-full'>
            <div className='relative h-full w-full lg:w-[55%] shadow-sm rounded-xl bg-white mt-5 p-3 flex flex-col lg:flex-row justify-between items-start lg:items-center'>
                ...
                <div className="border border-dashed border-gray-900 w-full lg:w-0  lg:h-full"></div>
