    ...
    return (
        <div className='h-[300px] lg:h-[350px] w-full flex justify-between items-center mt-20'>
            <div className='h-full w-full lg:w-[40%]'>
                ...
                <h1 className='text-md text-slate-500 mt-4 dark:text-slate-300'>A passionate Junior Product Designer with a strong background in motion design and illustration. With a deep love for creativity and innovation, I’ve crafted engaging visual experiences and intuitive, user-friendly interfaces.<br />
